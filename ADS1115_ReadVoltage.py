...
# Define register configuration for different voltage ranges on the ADS1115
# These constants define the gain and input voltage range for the ADS1115
...
# Set the IIC address of the ADS1115
# Set the I2C address of the ADS1115 module
ads1115.setAddr_ADS1115(0x49)

# Set the gain and input voltage range of the ADS1115
# Set the gain and input voltage range to 6.144V range = Gain 2/3
ads1115.setGain(ADS1115_REG_CONFIG_PGA_6_144V)

# Define constants for voltage reference and buffer arrays
VREF = 5.0
...
def getMedianNum(iFilterLen):
    # This function calculates the median value of the analog buffer
...
while True :
    # Check if it's time to take a new analog reading
    ...
    # Check if it's time to print the TDS value
